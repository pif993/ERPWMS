...
func (h StockHandlers) ListBalances(c *gin.Context) {
	...
	rows, err := h.Queries.ListStockBalances(c, sqlcgen.ListStockBalancesParams{Column1: c.Query("q"), Column2: c.Query("warehouse"), Column3: c.Query("location"), Limit: int32(limit), Offset: int32(offset)})
	if err != nil {
...
func (h StockHandlers) Move(c *gin.Context) {
	...
	resp, err := h.Service.MoveStock(c, req, uid, "/api/stock/moves", key)
	if err != nil {
